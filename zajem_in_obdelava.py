...
def izloci_podatke(blok):
    ...
    viski['cas_ocene'] = str(viski['cas_ocene'])
    viski['ime'] = str(viski['ime'])
    viski['opis'] = str(viski['opis'])
    viski['kategorija'] = str(viski['kategorija'])
    viski['ocenjevalec'] = str(viski['ocenjevalec'])
